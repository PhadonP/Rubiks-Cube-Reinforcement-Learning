...
class GUI:
    def __init__(self, game):
        ...
        self.titleFont = pygame.font.Font(
            "freesansbold.ttf", self.titleFontSize)
...
if __name__ == "__main__":
    ...
    while True:  # main game loop
        ...
        if puzzleN.checkIfSolvedSingle(puzzleN.state):
            ...
            msg = "Solving..."
        elif GUI.state == GUIState.animate:
        ...
        if GUI.state == GUIState.animate and currTime - prevTime > 0.25:
            if i == len(moves):
                GUI.state = GUIState.ready
            else:
                prevTime = currTime
