...
class InteractiveEnv():
    def __init__(self, game):
        ...
        self.xMargin = int((self.windowWidth - (self.tileSize * self.rowLength + (self.rowLength - 1))) / 2)
        self.yMargin = int((self.windowHeight - (self.tileSize * self.rowLength + (self.rowLength - 1))) / 2) 
    ...
    def drawGame(self, msg):
        ...
        if msg:
            self.textSurf, self.textRect = self.makeText(msg, self.font, self.messageColour, self.bgColour, 30, self.windowHeight - 40)
        ...
        pygame.draw.rect(self.displaySurf, self.borderColour, (left - 5, top - 5, width + 11, height + 11), 4)
    ...
    def drawTile(self, tileX, tileY, number, adjX = 0, adjY = 0):
        ...
        pygame.draw.rect(self.displaySurf, self.tileColour, (left + adjX, top + adjY, self.tileSize, self.tileSize))
